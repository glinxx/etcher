  ...
  return new Bluebird((resolve, reject) => {
    ...
    ipc.connectTo(process.env.IPC_SERVER_ID, () => {
      ...
      ipc.of[process.env.IPC_SERVER_ID].on('connect', () => {
        ...
        // Make sure the child process exits when this process dies.
        // Turns out that when the parent process gets SIGKILL, the
        // children process would still remain alive.
        process.on('exit', () => {
          if (child) {
            child.kill();
          }
